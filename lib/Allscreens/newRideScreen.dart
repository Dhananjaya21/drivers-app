...
class _NewRideScreenState extends State<NewRideScreen>
{
  ...
  void acceptRideRequest()
  {
    ...
    newRequestsRef.child(rideRequestId).child("car_details").set('${driversInformation!.vehicle_type} - ${driversInformation!.vehicle_route}');
  ...
  endTheTrip() async
  {
    ...
    showDialog(
      context: context,
      barrierDismissible: false,
      builder: (BuildContext context)=> CollectFareDialog(paymentMethod: widget.rideDetails!.payment_methods, fareAmount: fareAmount,),
    );
